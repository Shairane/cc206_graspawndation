    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          ...
          elevation: 50.0,
          shadowColor: const Color.fromARGB(255, 255, 114, 208),       
                ...
                Padding(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      ...
                      color: Color.fromARGB(255, 117, 4, 108),
                    ),
                  ),
                ),
            Padding(
              ...
              child: Text(
                ...
                style: TextStyle(
                  ...
                  backgroundColor: Color.fromARGB(255, 255, 182, 237),
                ),
              )
            ),
            AnimalSearchBar(),
    ...
    return Card(
      ...
      child: Container(
        decoration: BoxDecoration(
            color: const Color.fromARGB(255, 255, 182, 238),
            border: Border.all(),
